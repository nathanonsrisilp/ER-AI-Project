...
- **Real-time Display**
  - Shows incoming emergency reports generated by the AI system

- **History Page**
  - Stores and displays past emergency cases
  - Allows operators to review previously reported incidents

- **Map Integration**
  - Visualizes incident locations on an interactive map
  - Helps responders quickly understand geographic context

- **Editable Interface**
  - Operators can review, modify, and confirm AI-generated reports
  - Supports human-in-the-loop validation before dispatch

### Purpose

The dashboard acts as the control center of the system, enabling:

- Efficient decision-making  
- Improved situational awareness  
- Seamless interaction between AI outputs and human operators
  
- ### Role in System Workflow

The Streamlit dashboard is positioned between AI processing and dispatch:
```
Telegram Input
   ↓
AI Processing
